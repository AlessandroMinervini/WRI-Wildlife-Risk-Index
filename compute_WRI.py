...
def  merge_BS():
    birdstrike_A_PSA = pd.read_csv('WRI/birdstrike_A_PSA.csv')
    birdstrike_B_PSA = pd.read_csv('WRI/birdstrike_B_PSA.csv')
    birdstrike_C_PSA = pd.read_csv('WRI/birdstrike_C_PSA.csv')
    birdstrike_D_PSA = pd.read_csv('WRI/birdstrike_D_PSA.csv')
    ...
    cols = ['id_aeroporto', 'data', 'data_', 'effettoSulVolo', 'id_specie_volatile', 'id_gruppo', 'coinvolti', 'parti_colpite']

    birdstrike_B_PSA['coinvolti'] = 1
    birdstrike_D_PSA['parti_colpite'] = ''

    birdstrike_A_PSA.columns = ['id_aeroporto', 'data', 'data_', 'effettoSulVolo', 'id_specie_volatile', 'id_gruppo', 'coinvolti', 'parti_colpite']
    birdstrike_B_PSA.columns = ['id_aeroporto', 'data', 'data_', 'effettoSulVolo', 'id_specie_volatile', 'id_gruppo', 'parti_colpite', 'coinvolti']
    birdstrike_C_PSA.columns = ['id_aeroporto', 'data', 'data_', 'effettoSulVolo', 'id_specie_volatile', 'id_gruppo', 'coinvolti', 'parti_colpite']
    birdstrike_D_PSA.columns = ['id_aeroporto', 'data', 'data_', 'effettoSulVolo', 'id_specie_volatile', 'id_gruppo', 'coinvolti', 'parti_colpite']
